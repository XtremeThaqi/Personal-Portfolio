            ...
            <div className="flex items-center justify-center h-[100%] m-auto pt-[140px] pb-[100px] pl-0 pr-0 overflow-hidden" id="about">
                <div className="flex flex-col justify-center max-[550px]:px-5 p-[10px]">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.5 }}
                        className="max-w-[500px] text-[#cf2525]">
                        <i>
                    ...
                    <motion.div
                        ...
                        className="mt-[100px]">
                        <a href="#contact">
                            <button className='shadow-2 text-black bg-[#cf2525] border-[1px] pt-[4px] pb-[4px] pl-[20px] pr-[20px] text-[15px] rounded-3xl cursor-pointe hover:bg-black hover:text-[#cf2525] hover:border border-[#cf2525] border-solid transition-all duration-300 ease-linear max-sm:text-[15px]'>
                                Contact Me
                            </button>
                        </a>
                    </motion.div>
